      ...
      {/* 여기부터 투표게시판 컴포넌트 */}
        <div className="max-w-[1300px] col-span-8 border-x-2 p-3">
          ...
          <a href="/community/vote" 
            className="community-tab-active flex items-center text-[25px] font-bold"
            >
              <img 
                src={voteIcon} 
                alt=""
                className="w-10 h-10 place-content-center" 
                />
            ...
            <a 
              ...
              className="community-tab-deactive flex items-center text-[25px] hover:bg-gray-100 font-bold"
              ...
              <img 
                src={communityIcon}
                alt="자유"
                className="w-10 h-10 place-content-center mt-1"
                />
          ...
          <div className="community-notice border-y-[2px] border-black flex flex-col place-content-center p-1">
            ...
            <p className='text-lg'>글 및 댓글 수정, 삭제가 불가하니 유의해주세요</p>
          </div>
          </div>
          </div>
)}
